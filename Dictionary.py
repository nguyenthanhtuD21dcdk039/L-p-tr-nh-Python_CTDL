...
Từ điển có thể thay đổi, nghĩa là chúng ta có thể thay đổi, thêm hoặc bớt các mục sau khi dictionary được khởi tạo.
...
# Hoặc có thể dùng hàm "update()" sẽ cập nhật từ điển với các mục từ đối số đã cho. Và có thể thay đổi nhiều mã cùng 1 lúc
