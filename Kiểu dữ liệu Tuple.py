...
for x in TraiCay:
    print(x)
# Cộng hai Tuple là nối 2 tuple lại thành một tuple mới, và không phải cộng từng phần tử lại với nhau
x = (1, 2, 3) + (4, 5, 6)
print(x)
y = (1, 2, 3) * 2
print(y)
...
# Và cũng có thể tìm min, max, sum
print(min(Gioitinh))
print(max(TraiCay))
print(min(lopHoc))
print(max(lopHoc))
print(sum(lopHoc))  # Chỉ dùng với số
