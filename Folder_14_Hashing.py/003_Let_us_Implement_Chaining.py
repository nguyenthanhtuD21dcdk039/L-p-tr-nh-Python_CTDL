...
class HashChain:
    ...
    def __init__(self):
        ...
        self.hashtable = [
            0
        ] * self.hashtable_size  # Tạo một danh sách các đối tượng LinkedList
    ...
    def insert(self, element):
        ...
        self.hashtable[i].insertsorted(
            element
        )  # Chèn phần tử vào danh sách liên kết ở vị trí mã băm tương ứng
